...
test("renders results with no pets", () => {
  const { asFragment } = render(<Results pets={[]} />);
  //   expect(asFragment()).matchSnapshot(); // for testing it just put the some words on the not found segment and see the result, for update press "u"
